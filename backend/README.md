...
## Project Structure
    ...
    ├── testapiautoteammem_112770  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_112770`
...
2. Clone this repo and `cd testapiautoteammem_112770`
